    ...
    <Section>
      <Container>
        ...
        <Flex col={2} className="flex-row-reverse d-md-flex d-block">
          ...
          <div className="w-100">
            <div className="d-none d-md-block" style={{ color: "#7A7A7A", width: "85%" }}>HaloPesa for corporates (Business Customers) are solutions for businesses that allow organizations to collect funds from their customers on a regular basis through HaloPesa or disburse funds to their customers just by a click of a button. HaloPesa is also a suitable means for Merchants to accept payments (HaloPesa Lipa Hapa) from customers with wallets.</div>
